...
const approveOpportunity = async (id) => {
    ...
    .insert([
      {
        ...
        application_link:
          submission.applyLink ||
          submission.application_link,
        image_url: null,
      },
    ]);
    ...
    previous.map((item) =>
      item.id === id
        ? {
            ...
            ...updatedSubmission,
            applyLink:
              updatedSubmission.application_link,
          }
        : item
    )
  );
  ...
  alert(
    "Opportunity approved and published successfully! ✅"
  );
};
  ...
  if (error) {
    console.error(
      "Decline opportunity error:",
      error
    );

    alert(
      "Could not decline opportunity:\n" +
      error.message
    );
  ...
  const exploreFilteredOpportunities = allOpportunities.filter(
  (item) => {
    ...
    const matchesLocation =
      ...
      item.location
        ?.toLowerCase()
        .includes(exploreLocation.toLowerCase());
    ...
    {showAboutLanguage && (
      <div className="about-language-overlay">
        ...
        <div className="about-language-modal">
          ...
          <p className="about-language-nepali-title">
            आफ्नो भाषा छान्नुहोस्
          </p>

          <p className="about-language-description">
            Select a language to learn more about Awasar Nepal.
          </p>

          <p className="about-language-description-nepali">
            Awasar Nepal बारे थप जानकारी लिन आफ्नो सुविधाअनुसार
            भाषा छान्नुहोस्।
          </p>
          ...
          <p className="about-language-footer">
...
<option value="BUSINESS">Business</option>
  ...
  <main className="explore-page">
    ...
    <section className="explore-hero">
      ...
      <p>
        Explore scholarships, jobs, internships, training,
        competitions and business opportunities in one place.
      </p>
    ...
    <section className="explore-content">
      ...
      <div className="explore-heading">
        ...
        <div>
          ...
          <p>
            {exploreFilteredOpportunities.length} opportunities found
          </p>
      ...
      <div className="explore-filters">
        ...
        <select
          ...
          onChange={(e) =>
            setExploreLocation(e.target.value)
          }
        >
  ...
  <section className="about-hero">
    ...
    <span className="about-badge">
      🇳🇵 Built for Nepal · नेपालका लागि निर्मित
    </span>
    ...
    <p>
      Awasar Nepal helps students, graduates, job seekers and
      young professionals discover scholarships, jobs, internships,
      training, competitions and other opportunities in one place.
    </p>

    <p className="about-nepali">
      Awasar Nepal ले विद्यार्थी, स्नातक, रोजगारी खोज्ने तथा युवाहरूलाई
      छात्रवृत्ति, रोजगारी, इन्टर्नशिप, तालिम, प्रतियोगिता तथा अन्य
      अवसरहरू एउटै ठाउँमा खोज्न मद्दत गर्छ।
    </p>
    ...
    <div className="about-content">
      ...
      <div>
        ...
        <span className="section-label">
          ABOUT AWASAR NEPAL · अवसर नेपालबारे
        </span>
        ...
        <p className="about-nepali">
          विभिन्न वेबसाइट, सामाजिक सञ्जाल तथा संस्थाहरूमा जानकारी
          छरिएर हुँदा आफूलाई उपयुक्त अवसर खोज्न गाह्रो हुन सक्छ।
        </p>
        ...
        <p className="about-nepali">
          ...
          विभिन्न प्रकारका अवसरहरूलाई एउटै ठाउँमा ल्याएर प्रयोगकर्ताले
          खोजीमा कम समय र आफ्नो भविष्य निर्माणमा बढी समय दिन सकून्
          भन्ने हाम्रो उद्देश्य हो।
        </p>
      ...
      <div className="about-highlight">
        ...
        <div className="highlight-card">
          ...
          <p className="about-nepali">
            छात्रवृत्ति, प्रतियोगिता, इन्टर्नशिप तथा सिकाइका
            अवसरहरू खोज्नुहोस्।
          </p>
        ...
        <div className="highlight-card">
          ...
          <p className="about-nepali">
            तपाईंको लक्ष्यसँग मिल्ने रोजगारी तथा करियरका
            अवसरहरू खोज्नुहोस्।
          </p>
        ...
        <div className="highlight-card">
          ...
          <p className="about-nepali">
            तालिम, स्टार्टअप कार्यक्रम तथा विकासका अन्य
            अवसरहरू खोज्नुहोस्।
          </p>
  ...
  <section className="about-section about-mission">
    ...
    <p className="about-nepali">
      हाम्रो उद्देश्य सरल छ: नेपालभरिका मानिसहरूका लागि उपयोगी
      अवसरहरू अझ सजिलै पहुँचयोग्य बनाउनु।
    </p>
    ...
    <div className="mission-grid">
      ...
      <div className="mission-card">
        ...
        <p className="about-nepali">
          धेरै फरक प्लेटफर्महरू जाँच नगरी अवसरहरू खोज्नुहोस्
          र अन्वेषण गर्नुहोस्।
        </p>
      ...
      <div className="mission-card">
        ...
        <p className="about-nepali">
          तपाईंको रुचि, शिक्षा तथा लक्ष्यका आधारमा अवसरहरू
          खोज्नुहोस्।
        </p>
      ...
      <div className="mission-card">
        ...
        <p className="about-nepali">
          नेपाली विद्यार्थी तथा अवसर खोज्नेहरूको आवश्यकतालाई
          ध्यानमा राखेर बनाइएको प्लेटफर्म।
        </p>
  ...
  <section className="about-founder">
    ...
    <div className="founder-card">
      ...
      <div>
        ...
        <span className="section-label">
          FOUNDER & CREATOR · संस्थापक तथा निर्माता
        </span>
        ...
        <p className="about-nepali">
          नेपालका मानिसहरूले विभिन्न अवसरहरू सजिलै खोज्न र भेट्टाउन
          सकून् भन्ने दृष्टिकोणका साथ Awasar Nepal निर्माण गरिएको हो।
        </p>
  ...
  <section className="about-cta">
    ...
    <p className="about-nepali">
      अवसरहरू हेर्नुहोस् र तपाईंको लक्ष्यसँग मिल्ने अवसर खोज्नुहोस्।
    </p>
    ...
    <button
      ...
      onClick={() => setCurrentPage("opportunities")}
    >
      Explore Opportunities → / अवसरहरू हेर्नुहोस् →
    </button>
